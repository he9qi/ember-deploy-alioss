...
module.exports = CoreObject.extend({
  ...
  fileUpload: function(root, stat, next) {
    ...
    var uploadpath = filepath.replace(this.tmpDir, "").replace(/^(\.\/|\/)/, "");
